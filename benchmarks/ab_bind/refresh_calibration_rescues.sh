...
SOURCE_PLAN_ROOT="${ROOT}/runs/benchmarks/abbind_core_v1_quick_plan"
RUNS_ROOT="${ROOT}/runs/benchmarks/abbind_core_v1_calibration_rescues"
BATCH_PREFIX="${BATCH_PREFIX:-abbind-calibration-rescue}"
REPEAT_INCREMENT="${REPEAT_INCREMENT:-2}"
LAMBDA_INCREMENT="${LAMBDA_INCREMENT:-6}"
PRODUCTION_SCALE="${PRODUCTION_SCALE:-20.0}"
