...
if [ "${ABAG_ENABLE_GAP_RECOVERY_WATCHER:-0}" != "1" ]; then
  echo "Gap recovery watcher is disabled by default. Set ABAG_ENABLE_GAP_RECOVERY_WATCHER=1 to enable it." >&2
...
LAUNCH_COOLDOWN_SECONDS="${LAUNCH_COOLDOWN_SECONDS:-120}"
...
WATCHLIST_REFRESH_JSON="${WATCHLIST_REFRESH_JSON:-${RUNS_ROOT}/reports/watch/validation_gap_watchlist_refresh.json}"
