...
PROTOCOL_PATH="${PROTOCOL_PATH:-${BENCHMARK_ROOT}/protocol.1mlc_overlap_focus_pilot.yml}"
RUNS_ROOT="${RUNS_ROOT:-${ROOT}/runs/benchmarks/abbind_core_v1_validation_overlap_focus_pilot_1mlc_20260626}"
BATCH_PREFIX="${BATCH_PREFIX:-abbind-overlap-focus-pilot-1mlc}"
...
"${ROOT}/.venv/bin/python" "${BENCHMARK_ROOT}/report_hotspot_root_comparison.py" \
  ...
  --plan-root "pilot_1mlc=${ROOT}/runs/benchmarks/abbind_core_v1_validation_target_specific_sampling_pilot_1mlc_20260626" \
  --plan-root "overlap_focus_1mlc=${RUNS_ROOT}" \
